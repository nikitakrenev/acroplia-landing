module.exports = {
    ...
    items: [
      {
        title: "Education",
        description:
          "Learn and teach everything with our tools",
        icon: "icon-education"
      },
      {
        title: "Earn money",
        description:
          " Sell your services, tutor and broadcast paid webinars",
        icon: "icon-money"
      },
      {
        title: "Co-working",
        description:
          "Invite colleagues from any corner of the planet to meetings",
        icon: "icon-co-working"
      },
      {
        title: "Communication",
        description:
          "Chat with friends and family, share pictures and videos",
  ...
  security: {
    ...
    promoDescription: "We do our best to create an absolutely safety place for your work, communications  and all other activities. For that reasons we use next methods",
    items: [
      {
        title: "",
        description:"",
